...
# Пороги голосования для генерации сигнала (УЛУЧШЕНО: повышение качества входов)
VOTE_THRESHOLD_TRENDING = 3      # Было 1, стало 2 (снижение с 423 до ~75 сигналов/час)
VOTE_THRESHOLD_RANGING = 5       # Было 3, стало 4 (снижение с 423 до ~75 сигналов/час)
VOTE_THRESHOLD_TRANSITIONING = 6 # Было 4, стало 5 (снижение с 423 до ~75 сигналов/час)

# Минимальное количество пройденных фильтров для сигнала
MIN_FILTERS = 3  # Из 5 возможных фильтров
MIN_FILTERS_SELL = 2  # Для SELL сигналов (более строгие условия)
...
# Динамический стоп-лосс на основе ATR (УЛУЧШЕНО: более тесные SL для уменьшения убытков)
DYNAMIC_SL_ATR_MULTIPLIER = 3.5  # 3.5x ATR для расчета SL (было 4.0 - более тесный)
DYNAMIC_SL_MIN = 0.03  # Минимум 3% (было 5% - быстрее выход из убытков)
DYNAMIC_SL_MAX = 0.12  # Максимум 12% (было 15% - ограничить максимальный убыток)
...
MR_MAX_HOLDING_HOURS = 18  # УЛУЧШЕНО: максимум 18 часов удержания (было 24h - ускорен выход)
...
# Фильтр объёма v5.3 (УЛУЧШЕНО: добавлен минимальный объем для входа)
