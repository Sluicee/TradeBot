...
NO_BUY_IF_PRICE_BELOW_N_DAY_LOW_PERCENT = 0.05  # v5: Не входить если цена < min(24h) * 0.95
...
VOLUME_SPIKE_THRESHOLD = 1.8  # Не входить если volume > 1.8x средний за 24h (смягчили)
