...
# BTC-корреляция (ИСПРАВЛЕНО: предотвращает переинвестирование в коррелированные активы)
...
REAL_MIN_ORDER_VALUE = 10.0  # Минимальная сумма ордера (USD) для spot торговли Bybit
